...
import { addUser, getUsers, updateUser, deleteUser } from "../../services/adminApi";
        ...
        <div className="user-management__container mt-4">
            ...
            <table className="table table-striped user-management__table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th onClick={() => handleSort("firstName")} className="user-management__sortable-column">
                            First Name{" "}
                        ...
                        <th onClick={() => handleSort("lastName")} className="user-management__sortable-column">
                            Last Name{" "}
            ...
            {/* Modal add/edit user */}
            {modalVisible && (
                <div className="modal show d-block user-management__modal" tabIndex="-1" role="dialog">
                                ...
                                <form onSubmit={handleFormSubmit}>
                                    ...
                                    <div className="form-check mb-3">
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setForm({ ...form, phoneNumberConfirmed: e.target.checked })
                                            }
                                        />
                                        <label className="form-check-label" htmlFor="phoneNumberConfirmed">
                                            Phone Confirmed
                                        </label>
                                    </div>
